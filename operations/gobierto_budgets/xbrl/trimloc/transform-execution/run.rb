...
$DEV_DIR/gobierto-etl-utils/gobierto_budgets/xbrl/transform-execution/run.rb dictionary.yml data.xbrl <organization_id> <year> output.json

=end

if ARGV.length != 5
  puts "$DEV_DIR/gobierto-etl-utils/gobierto_budgets/xbrl/transform-execution/run.rb dictionary.yml data.xbrl <organization_id> <year> output.json"
