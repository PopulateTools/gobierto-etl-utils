...
# Generate XBRL TRIMLOC YAML dictionary to match XBRL budget line names with their elasticsearch equivalents
#
# bin/rails runner $DEV/populate-data-indicators/private_data/gobierto/xbrl/aux/create_xbrl_trimloc_dictionary.rb <xbrl_file>
...
if ARGV.empty? || ARGV.include?('-h') || ARGV.include?('--help')
  ...
  puts "      Format:"
  puts "        rails runner $DEV/populate-data-indicators/private_data/gobierto/xbrl/aux/create_xbrl_trimloc_dictionary.rb <xbrl_file>"
  puts "------------------------------\n"
  exit
end
...
partidas_ingresos_area_economica = GobiertoBudgets::EconomicArea.all_items[GobiertoBudgets::BudgetLine::INCOME]   # => 334 [ { "codigo" => "nombre" }]
partidas_gastos_area_economica   = GobiertoBudgets::EconomicArea.all_items[GobiertoBudgets::BudgetLine::EXPENSE]   # => 391
...
File.open(File.join(__dir__, "xbrl_trimloc_dictionary.yml"),"w") do |file|
